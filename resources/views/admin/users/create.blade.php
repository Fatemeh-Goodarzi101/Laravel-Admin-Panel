            ...
            <form class="form-horizontal" method="POST" action="{{ route('admin.users.store') }}">
              ...
              <div class="card-body">
                ...
                <div class="form-group col-sm-10">
                    ...
                    <input type="password" name="password_confirmation" class="form-control" id="password_confirmation" placeholder="تکرار پسورد را وارد کنید">
                </div>
                <div class="form-check">
                    <input type="checkbox" name="verify" id="verify" class="form-check-input">
                    <label class="form-check-lable" for="verify">اکانت فعال باشد</label>
                </div>
              </div>
              <!-- /.card-body -->
